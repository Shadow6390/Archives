 ...
 * @author jbraga
 */
public class Pump extends BaseExtractor{

    public Pump(IRandomDistribution dist, RandomSeedFactory factory, int randomStream, double chanceOfFailure)
    {
    ...
    {
        return ship instanceof EventPetrolShip;
    }
    ...
    {
        return dist.randomRange(30, 300);
    }
}
