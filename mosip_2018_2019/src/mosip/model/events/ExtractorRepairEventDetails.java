 ...
 * @author Diogo
 */
public class ExtractorRepairEventDetails extends EventDetailsBase
{
    ...
    public ExtractorRepairEventDetails(double timeStamp,IExtractor extractor,DockingBay bay,Simulation sim,boolean refireUnloading)
    {
