 ...
 * @author jbraga
 */
public class EventCruiseShip extends BaseShip{

    public EventCruiseShip(double arrivalTime, double requiredHeight, int maxExtractorsAllowed,Simulation sim,RandomSeedFactory factory,int randomStream,
    ...
    private double getUnloadTime(double numberExtractors, double expectedNumberExtractors)
    {
        ...
        double ddist = distribution.randomRange(15.0/numberExtractors, 30.0/numberExtractors);
    ...
    {
        double base = sim.getClock().getTime();
        return distribution.randomRange(base+5.0,base+15.0);
    }
    ...
    {
        double base = sim.getClock().getTime();
        return distribution.randomRange(base+5.0,base+10.0);
    }
    ...
    {
        double[] times = new double[]{7.5,25,25,7.5};
        return times;
    }
