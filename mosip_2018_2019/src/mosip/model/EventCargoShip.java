 ...
 * @author jbraga
 */
public class EventCargoShip extends BaseShip{

    public EventCargoShip(double arrivalTime, double requiredHeight, int maxExtractorsAllowed,Simulation sim,RandomSeedFactory factory,int randomStream,
    ...
    private double getUnloadTime(double numberExtractors, double expectedNumberExtractors)
    {
        ...
        double ddist = distribution.randomRange(300.0/numberExtractors, 900.0/numberExtractors);
    ...
    {
        double[] times = new double[]{25,600,600,25};
        return times;
    }
